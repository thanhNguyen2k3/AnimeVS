...
const Footer = () => {
    return (
        <section className="relative z-10 flex flex-col bg-gradient-to-b from-black to-sky-700/40 lg:justify-end font-poppins">
                ...
                <div className="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto lg:py-0">
                    <div className="flex flex-wrap py-10 -mx-3">
                        <div className="w-full px-4 mb-11 md:w-1/2 lg:w-4/12 lg:mb-0">
                            <a
                                href="#"
                                className="inline-block mb-4 text-xl font-semibold text-gray-200 dark:text-gray-400"
                            >
                                About Company
                            </a>
                            <p className="text-base font-normal leading-6 text-gray-400 lg:w-64 dark:text-gray-400">
                                Lorem ipsum dor amet Lorem ipsum dor amet Lorem ipsum dor amet Lorem ipsum dor amet
                            </p>
                        ...
                        <div className="w-full px-4 md:w-1/4 lg:w-2/12 mb-11 lg:mb-0">
                            <h2 className="mb-4 text-xl font-semibold text-gray-200 dark:text-gray-400">Services </h2>
                            <ul>
                                <li className="flex items-center mb-4 ">
                                    ...
                                    <a
                                        href="#"
                                        className="inline-block  text-sm font-normal text-gray-400 dark:text-gray-400"
                                    >
                                        Home
                                    </a>
                                </li>
                        ...
                        <div className="w-full px-4 md:w-1/4 lg:w-2/12 mb-11 lg:mb-0">
                            <h2 className="mb-4 text-xl font-semibold text-gray-200 dark:text-gray-400">Quick Links</h2>
                            <ul>
                                <li className="flex items-center mb-4 ">
                                    <i>
                                        <svg
                        ...
                        <div className="w-full px-4 mb-2 lg:mb-0 md:w-1/3 lg:w-4/12">
                            <h2 className="mb-4 text-lg font-semibold text-gray-200 dark:text-gray-400">
                                Contact Info
                            </h2>
                            <p className="flex items-center mb-4">
                                <i>
                                    <svg
                                        ...
                                        height="16"
                                        fill="currentColor"
                                        className="w-4 h-4 mr-1 text-gray-400 dark:text-gray-400 bi bi-geo-alt "
                                        viewBox="0 0 16 16"
                                    >
                                ...
                                <span className="text-gray-400 text-sm dark:text-gray-400">Kathmandu, Nepal</span>
                            </p>
                            <p className="flex items-center mb-4 ">
                                <i>
                                    <svg
                                        ...
                                        height="16"
                                        fill="currentColor"
                                        className="w-4 h-4 mr-2 text-gray-400 dark:text-gray-400 bi bi-envelope"
                                        viewBox="0 0 16 16"
                                    >
                                        <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z"></path>
                                    </svg>
                                </i>
                                <span className="text-gray-400 text-sm dark:text-gray-400">info@gmail.com</span>
                            </p>
                            <p className="flex items-center mb-4">
                                <i>
                                    <svg
                                        ...
                                        height="16"
                                        fill="currentColor"
                                        className="w-4 h-4 mr-2 text-gray-400 dark:text-gray-400 bi bi-telephone"
                                        viewBox="0 0 16 16"
                                    >
                                ...
                                <span className="text-gray-400 text-sm dark:text-gray-400">+977-9836736352</span>
                            </p>
                        </div>
                    </div>
                    <Divider className="bg-gray-600" />
                </div>
                <div className="py-5 text-center text-gray-200 dark:bg-gray-800 dark:text-gray-400">
