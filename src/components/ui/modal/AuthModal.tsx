...
const AuthModal = ({ setState, open }: Props) => {
        ...
        >
            <Box sx={style}>
                <div className="bg-white shadow rounded w-full p-10 mt-16">
                    <p tabIndex={0} className="text-2xl font-bold leading-6 max-md:text-base text-gray-800">
                    ...
                    >
                        ...
                        <p className="text-base font-medium ml-4 max-md:text-sm line-clamp-1 text-gray-700">
